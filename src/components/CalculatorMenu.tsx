...
const CalculatorMenu: React.FC<CalculatorMenuProps> = ({ setMode, setCurrentStep, theme }) => {
  return (
    <div className="text-center">
                                                <h3 className={theme === 'cyberpunk' ? 'text-2xl font-bold mb-8 text-cyber-cyan animate-neon-glow-multi' : 'text-2xl font-bold mb-8 text-gray-800'}>Select Calculation Mode:</h3>
